    ...
    return (
        <div className="Challenge">
                    ...
                    <div className="main-box">
                        <div className="box">
                            <div>
                                ...
                                <div className="app">Apps Released</div>
                            </div>
                        </div>
                        <div className="box">
                            <div>
            ...
            <div className="button-main">
                <button className="button-chalenge">Hire Talent <ArrowForwardIcon /> </button>
                <button className="button-chalenge-2">Find remote jobs <ArrowForwardIcon /></button>
            </div>
        </div>
    );
};
